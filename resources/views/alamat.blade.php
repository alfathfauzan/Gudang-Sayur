...
<body>
    ...
    <section class="address container">
        <div class="address-book">
                      ...
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            ...
                            <div class="modal-body">
                              ...
                              <div class="mb-3">
                                ...
                                <textarea id="description" cols="30" rows="10" class="form-control" name="description"></textarea><br>
            ...
            <div class="actions">
                <button type="button" data-bs-toggle="modal" data-bs-target="#editAddressModal" class="edit">Edit</button>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                                @csrf
                                @method('PUT')
                                <label for="nama_penerima" class="form-label">Nama Penerima:</label><br>
                                <input type="text" class="form-control" id="nama_penerima" name="nama_penerima"><br>
                                
                                <label for="nama_alamat" class="form-label">Nama Alamat:</label><br>
                                <input type="text" class="form-control" id="nama_alamat" name="nama_alamat"><br>
                        
                                <label for="city" class="form-label">Kota:</label><br>
                                <input type="text" class="form-control" id="city" name="city"><br>
                        
                                <label for="state" class="form-label">Provinsi:</label><br>
                                <input type="text" class="form-control" id="state" name="state"><br>
                        
                                <label for="zip_code" class="form-label">Kode Pos:</label><br>
                                <input type="text" class="form-control" id="zip_code" name="zip_code"><br>
        ...
        <a href="/"><button type="button" class="btn btn-outline-success">Back to HomePage</button></a>
